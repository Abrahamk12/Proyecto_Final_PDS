...
namespace Proyecto_Final_PDS
{
    public partial class m_maestros : Form
    {
        ...
        private void sacarPromediosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Sacar_promedios s_prom = new Sacar_promedios();
            s_prom.TopLevel = false;
            panel1.Controls.Add(s_prom);
            s_prom.Show();
        }
